...
// though some of those are also "mandatory for Active"; those are shown
// read-only and are never something the employee can be blocked on filling
// in themselves.
export const REQUIRED_PROFILE_FIELDS: Array<{ field: keyof Employee; label: string }> = [
...
export function computeProfileCompletion(employee: Employee): ProfileCompletion {
