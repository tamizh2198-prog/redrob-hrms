...
// Super Admin-only export of the active roster. PAN/Aadhaar/bank details
// are deliberately excluded, same as every other non-self/non-privileged
// view of an employee record masks them — this is a roster export, not a
// statutory-data dump.
export async function buildActiveEmployeesWorkbook(rows: ActiveEmployeeExportRow[]): Promise<Buffer> {
