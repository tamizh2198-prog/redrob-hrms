        ...
        <Card className="text-sm">
          ...
          <Tabs defaultValue="company">
            <TabsList>
              ...
              <TabsTrigger value="org-structure">Org Structure</TabsTrigger>
              <TabsTrigger value="integrations">Integrations</TabsTrigger>
              {isSuperAdmin && <TabsTrigger value="backup">Data Backup</TabsTrigger>}
            </TabsList>
            ...
            <TabsContent value="org-structure">
              ...
              {isSuperAdmin && (
                <div className="mt-4 flex flex-wrap items-end gap-2 border-t pt-3">
                  <Select value={unitType} onValueChange={(v) => setUnitType((v as OrgUnitType) ?? 'department')}>
                  ...
                  {unitType === 'department' && (
                    <Select value={unitParentId} onValueChange={(v) => setUnitParentId(v ?? '')}>
    ...
    <li className="flex flex-wrap items-center justify-between gap-2 rounded border p-2">
      ...
      {canEdit && (
        <div className="flex flex-wrap items-center gap-2">
          <Select value={status} onValueChange={(v) => setStatus((v as IntegrationConfig['status']) ?? 'NOT_CONFIGURED')}>
            <SelectTrigger className="w-40">
