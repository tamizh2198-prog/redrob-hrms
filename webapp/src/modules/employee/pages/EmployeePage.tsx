    ...
    <div className="flex flex-col gap-4 p-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          {isHrAdmin && (
            <Link href="/employee/change-requests">
        ...
        <TableBody>
          {employees.map((e) => (
            <TableRow key={e.id}>
              ...
              <TableCell>
                <Link href={`/employee/${e.id}`} className="text-primary underline-offset-4 hover:underline">
                ...
                <TableRow key={inv.id}>
                  ...
                  <TableCell>
                    <Button
                      ...
                      onClick={() => handleResend(inv.employeeId)}
                    >
                      {resendingId === inv.employeeId ? 'Sending…' : 'Remind'}
                    </Button>
                  </TableCell>
                </TableRow>
              ))}
