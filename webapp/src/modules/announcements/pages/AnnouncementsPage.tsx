...
export function AnnouncementsPage() {
  ...
  async function handleSendRecognition() {
    if (!recipientId || !recMessage || sendingRecognition) return
    setError(null)
    setMessage(null)
          ...
          {canCreateAnnouncement && (
            <Card>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select value={scope} onValueChange={(v) => setScope((v as AnnouncementScope) ?? 'ORGANIZATION')}>
                  <SelectTrigger>
                ...
                <Select value={priority} onValueChange={(v) => setPriority((v as AnnouncementPriority) ?? 'MEDIUM')}>
                  <SelectTrigger>
                ...
                <Button variant="outline" disabled={publishing} onClick={handleCreateAnnouncement}>
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    {a.requiresAck &&
                      (a.myAck?.acknowledgedAt ? (
                        ...
                        <Button size="sm" variant="outline" disabled={ackingId !== null} onClick={() => handleAck(a.id)}>
        ...
        <div className="flex flex-col gap-4">
          <Card>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Select value={recCategory} onValueChange={(v) => setRecCategory((v as RecognitionCategory) ?? 'TEAMWORK')}>
                <SelectTrigger>
              ...
              <Select value={recDepartmentId} onValueChange={(v) => setRecDepartmentId(v ?? '')}>
                <SelectTrigger>
              ...
              <Button variant="outline" disabled={sendingRecognition} onClick={handleSendRecognition}>
