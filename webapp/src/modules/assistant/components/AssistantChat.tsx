...
// Same chat logic/API this module has always used (sendMessage/confirmAction/
// uploadPolicyDocument) — extracted from the old full-page AssistantPage so
// FloatingAssistant can render it in a compact panel without a second,
  ...
  return (
    <div className="flex flex-col gap-3 p-3 text-sm">
      <p className="text-xs text-muted-foreground">
        Responses are AI-generated. Actions like applying leave or raising a ticket always
        require your explicit confirmation before anything is submitted.
      </p>
        ...
        <div className="rounded-md border p-3 text-sm">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button
              size="sm"
              variant="outline"
              disabled={uploadingPolicy || !policyTitle || !policyContent}
              onClick={handleUploadPolicy}
            >
              {uploadingPolicy ? 'Indexing…' : 'Index Document'}
            </Button>
          </div>
        </div>
      )}
